...
page.open("file:///" + rootPath + "/html/index.html", function (status) {
    if (status !== "success") {
    ...
    const jquery = page.injectJs(rootPath + "/js/jquery.min.js");
    const plotly = page.injectJs(rootPath + "/js/plotly.min.js");
